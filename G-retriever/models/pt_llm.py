...
class PromptTuningLLM(torch.nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        #Repeating or truncating tokens to match the desired number of virtual tokens.
        ...
        #detach(): Prevents gradients from being calculated for these embeddings.
        #clone(): Ensures a completely independent copy of the embeddings, protecting the original self.word_embedding.weight from unintended modifications during fine-tuning
    ...
    def forward(self, samples):
        ...
        prompt_embeds = self.prompt.repeat(batch_size, 1) #When processing a batch of samples, the same prompt embeddings (self.prompt) need to be replicated for each sample in the batch.
